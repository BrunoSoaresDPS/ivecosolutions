...
export default function MissionQualifier() {
  return (
    <div className="h-screen flex flex-col bg-background overflow-hidden">
      ...
      <header className="flex-shrink-0 bg-black text-white shadow-lg z-50">
        <div className="flex items-center justify-between h-14 sm:h-16 px-2 sm:px-4 lg:px-6">
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <span className="hidden sm:block text-white/70 text-sm">Classificador de Missão</span>
          </div>
          <ThemeToggle />
        </div>
      </header>
      ...
      {/* Full height iframe */}
      <iframe
        src="https://missionqualifier.lovable.app/"
        className="flex-1 w-full border-0"
        style={{ minHeight: 0 }}
        title="Classificador de Missão"
